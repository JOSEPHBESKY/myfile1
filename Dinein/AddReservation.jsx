           ...
           // debugger;
            ...
            if (!resp) {
                ...
                if (response.Resp.Sts == 1) {
                    ...
                    Swal.fire({
                        text:"Already existing Table Number",
                    });
                    // handleAE_CloseClick('');
                }
                            ...
                            <Card variant='outlined' style={{}} >
                                <CardContent>
                                    <div style={{ width: "100%", paddingLeft: '10px' }}>
                                        <div style={{ width: '100%', backgroundColor: 'white',float:'left'}}  >
                                            <Typography sx={{ fontSize: 12, textAlign: 'left', fontWeight: 'bold', paddingLeft: '6px',float:'left' }} color="text.secondary" gutterBottom>
                                               Table Number
                                            </Typography>
                                            {
                                    //         <Typography sx={{ fontSize: 12, textAlign: 'left', fontWeight: 'bold', paddingLeft: '150px',float:'left' }} color="text.secondary" gutterBottom>
                                    //         No Of Persons
                                    //      </Typography>
                                    //      <Typography sx={{ fontSize: 12, textAlign: 'left', fontWeight: 'bold', paddingLeft: '150px',float:'left' }} color="text.secondary" gutterBottom>
                                    //     Status
